...
SELECT playerid, namefirst, namelast, nl_winners.yearid, nl_teamid, al_teamid
FROM
	(SELECT a.playerid, a.lgid, a.awardid, a.yearid, m.teamid AS nl_teamid
...
INNER JOIN 
		   (SELECT a.playerid, a.lgid, a.awardid, a.yearid, m.teamid AS al_teamid
		    FROM awardsmanagers AS a
	 		INNER JOIN managers AS m
			USING(playerid, yearid)
	 		WHERE awardid = 'TSN Manager of the Year'
